namespace :text do
    ...
    #   :body => "Hi #{client.first_name} just wanted to wish you a happy new year! #{user.signature}")
    ...
    :from => "+1#{twilio_phone_number}",
    :to => number_to_send_to,
    :body => "Hi #{client.first_name} just wanted to wish you a happy Thanksgiving! #{user.signature}")
    ...
    :from => "+1#{twilio_phone_number}",
    :to => number_to_send_to,
    :body => "Hi #{client.first_name} just wanted to wish you a 4th of July! #{user.signature}")
    ...
    :from => "+1#{twilio_phone_number}",
    :to => number_to_send_to,
    :body => "Hi #{client.first_name} happy holidays! #{user.signature}")
